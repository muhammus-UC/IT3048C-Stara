...
class ShowsRecyclerViewAdapter(val showJSONs: List<ShowJSON>, val itemLayout: Int, val viewModel: MainViewModel, val email: String): RecyclerView.Adapter<ShowRecyclerViewHolder>() {
    /**
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ShowRecyclerViewHolder {
        ...
        return ShowRecyclerViewHolder(view, viewModel, email)
    }
