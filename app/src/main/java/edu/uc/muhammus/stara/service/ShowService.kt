...
class ShowService {
    internal fun fetchShows(showName: String) : MutableLiveData<ArrayList<Show>> {
        var _shows = MutableLiveData<ArrayList<Show>>()
        ...
        call?.enqueue(object: Callback<ArrayList<Show>> {
            /**
             * Invoked when a network exception occurred talking to the server or when an unexpected
             * exception occured creating the request or processing the response.
             */
            override fun onFailure(call: Call<ArrayList<Show>>, t: Throwable) {
            ...
            override fun onResponse(
                call: Call<ArrayList<Show>>,
                response: Response<ArrayList<Show>>
            ) {
