...
class ScheduleDataUnitTest {
    ...
    fun confirmDaisy_returnsDaisy() {
        val schedule = ScheduleJSON("Daisy Chain Gang", "09:00", Show("LEGO City Adventures"))
    ...
    private fun createMockData() {
        ...
        val backdraft = ScheduleJSON("Backdraft to School", "09:15", Show("LEGO City Adventures"))
        schedule.add(backdraft)
        val outdoor = ScheduleJSON("Outdoor Dishes", "11:00", Show("Delicious Miss Brown"))
        schedule.add(outdoor)
        val thrill = ScheduleJSON("The Thrill of Pizza on a Grill", "12:30", Show("Symon's Dinners Cooking Out"))
        schedule.add(thrill)
